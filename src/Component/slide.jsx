...
const Slide = () => {
    let show;
        function Sub() {
            if (show === 1) {
                ...
                document.getElementById("newsub").style.display = "inline"
                return show = 1;
            }
    ...
    return(
        <div>
            <div>
            <h4 className="col-md-2">Search Supplier</h4>
            <div className="col-md-2"><label >search</label><input type="search" name="text" id="supplier" /></div>
        </div>
        <div className="col-md-2">Suppliers</div>
        <nav>
        <label><i class="fas fa-times" id="cancel"></i></label>
        <ul>
            <button style={{ margin:" 0",padding: "0"}}>Import Data</button>
            <button onClick={Sub} style={{margin: "0", padding: "0"}} 
           >Add Supplier</button>
        </ul>
    </nav>
    <div className="container" id="newsub" style={{display:"block"}}>
        <h3>Add New Supplier</h3>
        <label className="name">Supplier Company Name : </label><input className="text" id="name"></input>
        <label className="address">Supplier Company Address : </label><input className="text"
            id="adress"></input><br/><br/>
        <label class="contry">Supplier Contry : </label><br/>
        <select id="Contry">
        ...
        <div>
            <label className="from">Source Port : </label><input className="text" id="from"></input>
        <label className="to">Destination Port : </label><input className="text"
            id="to"></input><br/><br/>
        </div>

        <div>
            <div class="mapouter">
                <div class="gmap_canvas"><iframe class="gmap_iframe"  title='fun' frameborder="0" scrolling="no" marginheight="0"
                        marginwidth="0"
                        ...
                        href="https://piratebay-proxys.com/">Pirate bay proxy</a></div>
